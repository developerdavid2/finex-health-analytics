    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-lg md:max-w-3xl lg:max-w-4xl xl:max-w-7xl relative">
        <div ref={animationRef} className="mb-8 md:mb-12">
          ...
          <div className="flex flex-col rounded-3xl border text-gray-800 font-semibold justify-center items-center p-4 md:p-6 border-black/10 backdrop-blur-sm bg-gray-500/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] overflow-hidden mx-auto w-full md:w-4/5 lg:w-3/4 xl:w-2/3 relative">
            <video
              autoPlay
              loop
              muted
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-11/12 md:w-5/6 lg:w-3/4">
              <div className="flex flex-col lg:flex-row gap-4 rounded-3xl border text-gray-800 font-semibold justify-center p-4 md:p-6 border-black/10 backdrop-blur-lg bg-pink-200/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] overflow-hidden w-3/4 md:w-full mx-auto">
                <div className="bg-pink-100 p-3 rounded-xl w-fit h-fit mx-auto lg:mx-0">
                  <FaAmbulance className="h-6 w-6 text-main" />
                </div>
                <div className="flex flex-col items-center lg:items-start justify-center gap-3 lg:gap-6 mb-0 lg:mb-4 w-full">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-400 text-center lg:text-left">
                    Optimized Movement, Better Outcomes.
                  </h2>
                  <p className="text-gray-200/40 text-center lg:text-start text-base md:text-lg font-medium max-w-full lg:max-w-sm">
