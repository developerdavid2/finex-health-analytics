    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-lg md:max-w-3xl lg:max-w-4xl xl:max-w-7xl relative">
        <div ref={animationRef} className="mb-8 md:mb-12">
          ...
          <div className="flex flex-col rounded-3xl border text-gray-800 font-semibold justify-center p-4 md:p-6 border-black/10 backdrop-blur-lg bg-pink-200/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] overflow-hidden w-fit mx-auto">
            ...
            <p className="text-main text-center text-base md:text-lg font-semibold max-w-sm">
              Protect sensitive health records with top-tier encryption and
              global compliance.
            </p>
          </div>

          <div className="grid xl:grid-cols-[1fr_2fr_1fr] relative justify-center items-center gap-8">
            {/* Left Panel - Image */}
            <div className="h-full w-full flex justify-around flex-none">
              <motion.div
