...
import { milestonesMainData } from "@/constants/milestones-page-data/milestones";
...
export default function MilestonesMainSection() {
  ...
  const filteredMilestones = useMemo(() => {
    return milestonesMainData.filter((item) =>
