...
export default function CustomerHeroSection() {
  ...
  const headlineText = "Building Lasting Partnerships in Healthcare Innovation";
          ...
          <div className="max-w-7xl px-4">
            ...
            <div className="flex items-center justify-center">
              ...
              <motion.div variants={variants} transition={transition}>
                <div className="bg-blue-200/10 border-2 border-white drop-shadow-2xl rounded-xl border-transparent animate-border text-base capitalize inline-flex justify-center whitespace-nowrap font-medium text-gray-700 backdrop-blur-[5rem] p-2 px-4 gap-2 items-center">
                  <p className="text-main font-semibold">OUR AUDIENCE</p>
                </div>
              </motion.div>
            ...
            <div className="max-w-5xl px-4">
              ...
              <motion.p
                ...
                variants={variants}
              >
                Finex works closely with healthcare providers, insurers, NGOs,
                and fintech partners to drive measurable outcomes and meaningful
                impact across global health systems.
              </motion.p>
            </div>
          </div>
        </motion.div>
