...
export default function AboutGrid() {
  ...
  return (
    <BentoGrid className="lg:grid-rows-3 pb-32">
      {aboutSections.map((feature) => (
        <BentoCard key={feature.name} {...feature} />
      ))}
      <div className="max-md:hidden flex justify-center items-center lg:col-start-3 lg:col-end-3 lg:row-start-3 lg:row-end-4 ">
        <Button
