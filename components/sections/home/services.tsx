...
export default function ServicesSection() {
  ...
  return (
    ...
    >
      <div
        ref={animationRef}
        className="flex flex-col container bg-pink-300/10 relative rounded-[5rem] py-[10rem] max-w-7xl mx-auto px-[6rem] mb-[10rem]"
      >
        <motion.div
        ...
        <div className="flex items-start gap-10">
          ...
          >
            ...
            <div className="flex justify-between text-start mt-14 space-x-20">
              <h2 className="text-4xl font-semibold text-gray-800">90%</h2>
              <p className="text-gray-600 text-sm">
          ...
          <div className="flex flex-col gap-8">
            <motion.div
              className="relative p-8 flex flex-col items-center text-center bg-white/10 rounded-3xl shadow-2xl backdrop-blur-2xl border border-white/50"
              initial="hidden"
              animate={initialState}
              variants={variants}
